                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        ...
                        <div className="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]">
                            {/* The following contains SVGs and styling from the original template */}
                            {/* Content omitted for brevity; kept identical to TSX version except types */}
                            {/* Begin SVGs */}
                            <svg
                            ...
                            {/* The rest of the SVG content remains unchanged from the TSX version */}
                        </div>
                    </main>
                </div>
